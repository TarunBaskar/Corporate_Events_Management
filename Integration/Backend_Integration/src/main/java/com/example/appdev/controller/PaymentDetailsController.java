...
public class PaymentDetailsController {
    ...
    public ResponseEntity<List<PaymentDetails>> getPaymentsByEmail(@PathVariable String email) {
        List<PaymentDetails> payments = paymentDetailsService.getPaymentsByEmail(email);
