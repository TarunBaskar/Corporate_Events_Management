...
public class PaymentDetailsService {
    ...
    public List<PaymentDetails> getPaymentsByEmail(String email) {
        return paymentDetailsRepository.findByPEmail(email);
    }
    ...
    public String updatePaymentDetails(long pId, PaymentDetails updatedPaymentDetails) {
        Optional<PaymentDetails> existingPaymentDetails = paymentDetailsRepository.findById(pId);
