            ...
            <>
              ...
              <div className="udb_part1">
                ...
                <div className="widgetudb">
                    {/* Widget 1: Total Payment */}
                    <div className="widget-box">
                    <h2>Total Payment</h2>
                    <p>$2,500</p>
                    </div>

                    {/* Widget 2: Total Events Attended */}
                    <div className="widget-box">
                    <h2>Total Events Attended</h2>
                    <p>5</p>
                    </div>

                    {/* Widget 3: Total Events Pending */}
                    <div className="widget-box">
      ...
      {/* </div>         */}
              ...
              <div className="upcommingudp">
                ...
                <div className="event-cards-container">
                  ...
                  <div className="event-card">
                    <img
                      src="https://blog.ipleaders.in/wp-content/uploads/2016/09/Shareholder-Meeting.jpg" // Replace with your event image URL
                      alt="Event"
                      className="event-image"
                    />
                    <div className="event-details">
                  ...
                  <div className="event-card">
                    <img
                      src="https://www.tmwproductions.biz/wp-content/uploads/2021/01/health-events-388x259.jpeg" // Replace with your event image URL
                      alt="Event"
                      className="event-image"
                    />
                    <div className="event-details">
